...
/**
 * Stores enough information about the state of the board and the move being
 * applied to undo that move later. This class exists for the sole purpose of
...
public class UndoMove implements Creatable<UndoMove> {
	...
	public UndoMove init(ArrayBoard currentBoard, ArrayMove move) {
		...
		System.arraycopy(currentBoard.canCastleKingside, 0, this.canCastleKingside, 0,
				currentBoard.canCastleKingside.length);
		System.arraycopy(currentBoard.canCastleQueenside, 0, this.canCastleQueenside, 0,
				currentBoard.canCastleQueenside.length);
