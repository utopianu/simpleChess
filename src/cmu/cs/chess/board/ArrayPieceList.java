...
public class ArrayPieceList {
	...
	public int countOfType(int type) {
		return countOfPiece(makePieceCode(WHITE, type)) + countOfPiece(makePieceCode(BLACK, type));
	}
	...
	public boolean equals(Object o) {
		if (this == o)
			return true;
		if (!(o instanceof ArrayPieceList))
			return false;

		ArrayPieceList ps = (ArrayPieceList) o;

		if (this.countOfAllPieces() != ps.countOfAllPieces())
			return false;
	...
	/**
	 * Returns an iterable iterator over the pieces in this piece list which
	 * match any of the pieces in the specified array.
	 * 
	 * @param pieces
	 *            the pieces to iterate over.
