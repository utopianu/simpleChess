...
public final class CapturedPieces extends JPanel {
	...
	private JLabel[] counts = { new JLabel("0"), new JLabel("0"), new JLabel("0"), new JLabel("0"), new JLabel("0") };
	...
	private final class PieceBox extends Canvas {
		...
		public void paint(Graphics g) {
			...
			for (int i = 0; i < numPieceTypes; i++) {
				painter.drawPiece(g, pieceOrder.charAt(i), squareSize, 0, i * squareSize);
			}
		}
	}
	...
	private final class Layout implements LayoutManager {
		@SuppressWarnings("unused")
		private Component pieces, queenCount, bishopCount, knightCount, rookCount, pawnCount;
		...
		public void addLayoutComponent(String name, Component comp) {
			if ("Pieces".equals(name)) {
				...
				throw new RuntimeException("CapturedPieces.Layout: Unsupported component type \"" + name + "\"");
			}
		}
