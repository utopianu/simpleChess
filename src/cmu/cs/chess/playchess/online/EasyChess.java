package cmu.cs.chess.playchess.online;
	...
	private class MyHandler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == buttonConnect) {
				...
				if (!connected) {
					status_bar.setText("Status: Connecting to the 15-211 server...");

					hub.connect();
					connected = true;
				}
				status_bar.setText("Status: Logging on to the 15-211 server...");
				hub.login(u1, p1);
